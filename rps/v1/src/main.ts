...
const userCol2 = getElementByIdOrThrow<HTMLDivElement>("user-row2");
...
//   console.log(roundSelector.style[key] = String(userColPos[key]) + "px");
// };

// btn.addEventListener("click", (e) => {
//   for (const key of ["top", "right", "bottom", "left"] as const) {
//     roundSelector.style[key] = String(userColPos2[key]) + "px";
//     // roundSelector.style.transition = "5000ms";
//   }
//   userCol2.append(roundSelector);
// })

// roundSelector.style.top = (roundSelector.offsetTop - userCol2.offsetTop) + "px";
// roundSelector.style.left = (roundSelector.offsetLeft - userCol2.offsetLeft) + "px";
...
btn.addEventListener("click", (e) => {
  for (const key of ["top", "right", "bottom", "left", "width", "height"] as const) {
    roundSelector.style[key] = String(userColPos2[key] + "px");
    roundSelector.style.transition = "300ms";
  }
});
